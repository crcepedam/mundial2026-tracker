...
function buildMatchProbs(fixture, oddsData, kalshiData, footballData) {
  ...
  function predictScore(pH, pA) {
    if (pH > 65) return { score:"2-0", hg:2, ag:0 };
    if (pH > 52) return { score:"1-0", hg:1, ag:0 };
    if (pA > 65) return { score:"0-2", hg:0, ag:2 };
    if (pA > 52) return { score:"0-1", hg:0, ag:1 };
    return { score:"1-1", hg:1, ag:1 };
  }
